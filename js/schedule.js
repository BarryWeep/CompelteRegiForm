...
function InitialPage()
{
  ...
  document.getElementById("referenceDate").min = Userlist[0].date;
  document.getElementById("duration").value = Userlist[0].Duration + " mins";
  putSelectValue()
  renderTheList();
...
function renderTheList()
{
    ...
    for(let initor = 0; initor<3; initor++)
    {
      ...
      if(DayParameter==0)
      {
        headthree.innerHTML = weekdaylist[6]+" "+ listweekday[initor];
      }
      else
      {
...
function UpdateDataTolocate()
{
    Userlist[0].date = document.getElementById('referenceDate').value;
    Userlist[0].Duration = document.getElementById('duration').value;
    Userlist[0].StartTime = document.getElementById('startTimeSelect').value;
    Userlist[0].EndTime = document.getElementById('EndTimeSelect').value;
